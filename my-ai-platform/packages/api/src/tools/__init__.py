...
只返回 JSON 数组。"""
    ...
    return [search_notes, save_note, get_note, archive_note, get_notes_summary, synthesize_notes, get_note_relations, detect_collisions, suggest_tags, suggest_relation, accept_suggestion, reject_suggestion, merge_tags, list_tag_aliases, web_search, import_webpage]
